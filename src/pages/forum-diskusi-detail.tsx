...
export default function ForumDiskusiDetail() {
  ...
  const handleReplySubmit = async () => {
    ...
    const newReplyObj: Reply = {
      ...
      author: randomUser.name.first + ' ' + randomUser.name.last,
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700">
      ...
      <div className="flex items-center mb-4">
        <Image src={forumTopic.authorImg} alt={forumTopic.author} width={40} height={40} className="rounded-full" />
        <div className="ml-3">
        ...
        {forumTopic.replies.map((reply) => (
          <div key={reply.id} className="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg">
            <div className="flex items-center mb-2">
              <Image src={reply.authorImg} alt={reply.author} width={30} height={30} className="rounded-full" />
              <div className="ml-3">
      ...
      <div className="mt-6 flex items-center border-t pt-4">
        ...
        />
        <button onClick={handleReplySubmit} className="px-4 py-2 bg-blue-500 text-white rounded-r-lg flex items-center">
